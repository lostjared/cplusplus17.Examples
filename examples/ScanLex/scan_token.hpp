...
namespace scan {
    ...
    enum OP_TYPES { OP_NOT=0, OP_AT, OP_DOLLAR, OP_MOD,OP_XOR,OP_AND,OP_MUL, OP_OP, OP_CP, OP_MINUS, OP_PLUS, OP_MINUS_MINUS, OP_PLUSPLUS, OP_SHIFT_RIGHT, OP_SHIFT_LEFT, OP_EQ_EQ, OP_NE, OP_PE, OP_MINE, OP_ME, OP_AE, OP_OE, OP_XE, OP_MOD_E, OP_AND_AND, OP_OR_OR,OP_LESS, OP_GREATER, OP_BRACE_O, OP_BRACE_C, OP_BLOCK_O, OP_BLOCK_C, OP_DOT, OP_COMMA, OP_COLON, OP_SEMI_COLON, OP_EQUAL, OP_DIV, OP_OR, OP_DE, OP_EMPTY };
    class Token {
    public:
        Token();
