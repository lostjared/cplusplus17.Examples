...
namespace scan {
    ...
    static const char *keywords[] = {"proc", "let", "if", "else","elif","for", "while", "call","begin", "end", "match","print","input", 0};
    enum KEYWORD_TYPES{ KEY_PROC=0, KEY_LET, KEY_IF, KEY_ELSE, KEY_ELIF, KEY_FOR, KEY_WHILE, KEY_CALL, KEY_BEGIN, KEY_END, KEY_MATCH,KEY_PRINT,KEY_INPUT,KEY_EMPTY };
