...
namespace backend {
    ...
    enum OPERATION_TYPE { O_SASSIGN, O_ASSIGN, O_ADD, O_SUB, O_MUL, O_DIV, O_CALL, O_PUSH, O_POP };
    static const char *op_types[] = {"SASSIGN", "ASSIGN", "ADD", "SUB", "MUL", "DIV", "CALL", "PUSH","POP", 0};
